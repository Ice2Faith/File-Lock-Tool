...
{
    FaceInt("f5","FileLockToolProV7.1 Dev: Ice2Faith Ver: 7.1",85);
    if(num==1)
    {
        UserGuid();
    }
...
void ControlCenter(int num,char * string[])
{
    ...
    if(del=='*')
    {
        ...
        fputs("@echo off\n",Bat);
        fputs("echo Builder: FileLockToolProV7.1\n",Bat);
        fputs("echo Ver: 7.1\n",Bat);
    ...
    fputs(">>>>>>>>>>>>\tIce2Faith FileLockToolProV7.1 informations\n\n",Password);
    fprintf(Password,"Ver: \t\t7.1\n\n",Password);
